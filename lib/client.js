// DSH Thinking Fullscreen — client plugin bundle v1.0
// 由动态插件 dtf-1/pkg-19 (v3.5) 固化而来。
window.__ModuleLoader__.load({
  id: "@deepseek-ai/dsh-thinking-fullscreen",
  factory: (require) => {
    var module = { exports: {} };
...
.dtf-meta{position:absolute;right:22px;top:12px;font-size:12px;color:#6b7d9e;font-family:'JetBrains Mono',Consolas,monospace;letter-spacing:.4px;z-index:3}`;
    ...
    function injectCss() {
      ...
      if (document.querySelector('style[data-plugin="dsh-thinking-fullscreen"]')) return;
      const tag = document.createElement("style");
      tag.dataset.plugin = "dsh-thinking-fullscreen";
    ...
    exports.name = "dsh-thinking-fullscreen";
